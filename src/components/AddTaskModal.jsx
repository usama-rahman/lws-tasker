...
export default function AddTaskModal({
  ...
  return (
    <>
      <div className="bg-black bg-opacity-70 h-[135%] w-full z-10 absolute top-0 left-0"></div>
        ...
        <form className="w-full max-w-[740px] rounded-xl border border-[#FEFBFB]/[36%]  bg-[#191D26] p-9 max-md:px-4  z-20 absolute">
          ...
          <div className="mt-16 flex justify-center lg:mt-20">
            <button
              ...
              className="mx-5 rounded bg-red-900 px-4 py-2 text-white transition-all hover:opacity-80"
            >
              Cancel
            </button>
            <button
